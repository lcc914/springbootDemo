...
//    private static String srcPath = "test";


    //基本包名
    private static String basePackage = "com.demo";
    //作者
    ...
    private static String url = "jdbc:mysql://localhost:3306/mydb?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
    ...
    public static void main(String[] args) {
        ...
        gen.setGlobalConfig(new GlobalConfig()
                .setOutputDir(baseProjectPath + "/src/" + srcPath + "/java")//输出目录
...
//                        .setInclude(tables) // 需要生成的表
        ...
        fileOutList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return baseProjectPath + "/src/" + srcPath + "/resources/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
